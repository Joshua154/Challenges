...
public class oldForceBlock extends GameMod {
    ...
    public oldForceBlock() {
        super("Force Block", "ofb", Material.BLAZE_ROD, ModManager.ModType.PLAYER, ModManager.ModStatus.CLOSED_BETA, "Forces a block to be on in a Specific Time.");
